...
export const content = {
  es: {
    ...
    aboutImageAlt:
      "Niñas y niños participan en una actividad de volcanes con niebla durante un taller científico de Boom! Lab.",
  ...
  en: {
    ...
    aboutImageAlt:
      "Children take part in a foggy volcano activity during a Boom! Lab science workshop.",
