  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        ["Contact form", ["The current form prepares a message in the visitor’s email application. Boom! Lab receives the details only after that visitor confirms sending it. Information may include name, email, phone, location, activity type, tentative date, participant count and message.", "We use those details to answer the enquiry, prepare guidance or a quote and maintain necessary communication. Children should not submit personal information directly; the form is intended for responsible adults."]],
