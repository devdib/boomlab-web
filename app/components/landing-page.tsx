    ...
    "@graph": [
      {
        ...
        name: "Boom! Lab",
        url: `${siteUrl}/${locale}`,
        logo: `${siteUrl}/logo-boomlab.svg`,
        email: contactDetails.email,
        telephone: contactDetails.phone,
        sameAs: [contactDetails.instagramHref],
        areaServed: [{ "@type": "City", name: "Santiago" }, { "@type": "City", name: "Concepción" }],
      },
      {
        "@type": "WebSite",
        "@id": `${siteUrl}/#website`,
      ...
      <section className="section about-section" id={pageIds.about}>
        <div className="shell about-grid">
          <figure className="about-art">
            <img
              src="/images/boomlab-taller-volcanes.webp"
              alt={t.aboutImageAlt}
              width={591}
              height={1055}
            />
